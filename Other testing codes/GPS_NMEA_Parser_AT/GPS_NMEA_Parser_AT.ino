...
void printGPSData() {
  ...
  Serial.printf("Raw Latitude: %s, Direction: %c\n", lat, latDir);
  Serial.printf("Raw Longitude: %s, Direction: %c\n", lon, lonDir);
  Serial.printf("Fix Quality: %d, Satellites: %d\n", gpsData.fixQuality, gpsData.satellites);
