...
Added robust checksum validation for NMEA sentences
Improved string handling with safe copy operations
Better GPS fix validation with multiple criteria
Proper handling of millis() rollover
Added GPS module reset functionality
Enhanced error checking in NMEA sentence parsing
Better time formatting
Consistent debugging output
Added tracking of last valid fix
Improved timeout handling with separate warning and reset timeouts

To use this code:

Connect your UBlox GPS module to the specified pins (GPS_RX: 17, GPS_TX: 16)
